...
정의 : Nginx는 웹 서버이며, 리버스 프록시, 로드 밸런서, 그리고 http 캐시로도 쓰일 수 있는 소프트웨어이다. 요청에 응답하기 위해 이벤트 기반 구조를 채택했고, 현재 웹 서버 분야에서 1등이다.
...
- Nginx를 사용하는 이유?
  ...
  | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | ![image](https://user-images.githubusercontent.com/87461672/158042025-71b63162-4019-4015-a62d-6d4a0f371f94.png) | ![image-20220313112002934](../AppData/Roaming/Typora/typora-user-images/image-20220313112002934.png) |
...
|                   동시에 연결된 커넥션 수                    |                      초당 요청 처리 수                       |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![image-20220313114923667](../AppData/Roaming/Typora/typora-user-images/image-20220313114923667.png) | ![image](https://user-images.githubusercontent.com/87461672/158042796-9904566c-e01d-4187-a530-df371c6572b4.png) |
